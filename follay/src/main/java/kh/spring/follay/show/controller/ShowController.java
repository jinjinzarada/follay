...
//			return mv;
//		}
		int result = service.insertShow(show);
		mv.setViewName("redirect:/show/list");
		return mv;
	...
	public ModelAndView list(@RequestParam(name="page", defaultValue = "1") int currentPage
		...
		List<Show> showlist = service.selectShowList(currentPage, pageSize);
